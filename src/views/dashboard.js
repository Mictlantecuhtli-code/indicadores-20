...
function buildSummary(realData, type, scenario) {
  ...
  // CAMBIO: Para fauna, forzar escenario BAJO
  ...
  return {
    title: `${SCENARIO_LABELS[effectiveScenario] || 'Meta'} (${month?.label || ''} ${latestYear})`,
    currentLabel: 'Real',
    comparisonLabel: isFaunaImpact ? 'Meta' : 'Meta',
    currentValue: current,
    comparisonValue: comparison,
    diff,
    pct
